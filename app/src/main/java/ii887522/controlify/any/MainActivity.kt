...
class MainActivity : AppCompatActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    ScoreModel(this, 0, { }, canIncrement = canIncrementScore0, canReset = canResetScore0).value.observe(this) {
      binding.score0.text = resources.getString(R.string.score_text, it)
    }
    ScoreModel(this, 1, { }, canIncrement = canIncrementScore0, canReset = canResetScore0).value.observe(this) {
      binding.score1.text = resources.getString(R.string.score_text, it)
    }
    ScoreModel(this, 1, {
      Timber.i("You win!")
    }, canIncrement = canIncrementScore0, canReset = canResetScore0).value.observe(this) {
      binding.score2.text = resources.getString(R.string.score_text, it)
    }
    ScoreModel(this, 1, {
      Timber.i("You win!")
    }, canIncrement = canIncrementScore1, canReset = canResetScore0).value.observe(this) {
      binding.score3.text = resources.getString(R.string.score_text, it)
    }
    ScoreModel(this, 1, {
      Timber.i("You win!")
    }, canIncrement = canIncrementScore1, canReset = canResetScore1).value.observe(this) {
